<%@ Page Title="New " Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="New_2.aspx.cs" Inherits="TranslationSys.New_2" %>
        ...
        <div class="row">
            <table style="width: 1022px; margin: 40px auto;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="Generator" runat="server" Text="生成框架" OnClick="Generator_Click" CausesValidation="False" />
                    </td>
                    <td>編號：</td>
                    <td>
                ...
                <tr>
                    <td class="">公文標題：</td>
                    <td>
                        <asp:TextBox ID="InputTitleZH" runat="server"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                    <td>denominação do documento oficial：</td>
                    <td>
                        <asp:TextBox ID="InputTitlePT" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="">&nbsp;</td>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="OutputToWord" runat="server" Text="輸出到Word" class="" data-toggle="modal" data-target="#myModal" />
                    </td>
                </tr>
                <tr>
                    <td colspan="5">
                        <asp:CheckBox ID="ListPointCB" runat="server" Text="List" Checked="True" />
                        <asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="百度翻譯" />
                        <asp:Button ID="Button8" runat="server" OnClick="Button8_Click" Text="有道翻譯" />
                    </td>
        ...
        <div class="row">
            <asp:Table ID="Table1" runat="server" Style="margin: auto auto;">
                <asp:TableRow runat="server" HorizontalAlign="Center" class="">
                    <asp:TableCell runat="server" ColumnSpan="2"><asp:Button OnClick="CHToPT_Click" Text="中翻葡" runat="server"/>
                    
                    </asp:TableCell>
                    <asp:TableCell runat="server" ColumnSpan="2">
					<asp:Button  Text="葡翻中" runat="server"/>
